...
export const metadata: Metadata = {
  ...
  description: 'Get in touch with BorderlessBits for expert cloud architecture and healthcare software consulting services.',
  keywords: ['contact', 'cloud architecture', 'healthcare software', 'consulting', 'BorderlessBits'],
  openGraph: {
    title: 'Contact BorderlessBits - Expert Cloud & Healthcare Consulting',
    description: 'Connect with our team for professional cloud architecture and healthcare software consulting services.',
    type: 'website',
  },
  twitter: {
