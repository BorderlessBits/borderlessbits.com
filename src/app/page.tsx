...
export const metadata: Metadata = {
  title: 'Home',
  description: 'Transform your enterprise with expert cloud architecture and healthcare software consulting. Specializing in AWS, Azure, HIPAA compliance, and scalable solutions.',
};
        ...
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-6">
            ...
            <nav className="hidden md:flex space-x-8">
              ...
              <a href="#case-studies" className="text-gray-700 hover:text-primary-600 transition-colors">
                Case Studies
              </a>
          ...
          <div className="container max-w-7xl">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                We provide comprehensive consulting services to help your organization 
                leverage modern cloud technologies and best practices.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <div className="card card-hover p-8">
                ...
                <p className="text-gray-600 mb-6">
                  Design and implement scalable, secure cloud infrastructures using AWS, Azure, 
                  and multi-cloud strategies tailored to your business needs.
                </p>
              ...
              <div className="card card-hover p-8">
                ...
                <p className="text-gray-600 mb-6">
                  Strategic technology consulting to help enterprises modernize their 
                  systems, improve efficiency, and drive digital transformation.
                </p>
                <ul className="text-sm text-gray-600 space-y-2">
                  <li className="flex items-center">
        ...
        <section id="contact" className="section bg-gray-50">
          <div className="container max-w-7xl">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Ready to transform your technology infrastructure? Let's discuss your 
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div>
              ...
              <p className="text-gray-300 mb-4">
                Expert cloud architecture and healthcare software consulting 
                for enterprise organizations.
              </p>
              <p className="text-sm text-gray-400">
                © 2024 BorderlessBits. All rights reserved.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-300">
                ...
                <li><a href="#services" className="hover:text-white transition-colors">Healthcare Software</a></li>
                <li><a href="#services" className="hover:text-white transition-colors">Enterprise Consulting</a></li>
              </ul>
            </div>
